...
class Timezone:
    ...
    UTC = 'UTC'
    UTC_9 = 'America/Anchorage'

    CHOICES = [
        ('Etc/GMT+12', '-12 Etc/GMT+12'),
        ('US/Samoa', '-11 US/Samoa'),
        ('Pacific/Honolulu', '-10 Pacific/Honolulu'),
        (UTC_9, '-09 America/Anchorage'),
        ('America/Los_Angeles', '-08 America/Los_Angeles'),
        ('America/Denver', '-07 America/Denver'),
        ('America/Chicago', '-06 America/Chicago'),
        ...
        ('Atlantic/Azores', '-01 Atlantic/Azores'),
        (UTC, '+00 UTC'),
        ('Europe/Berlin', '+01 Europe/Berlin'),
        ('Africa/Cairo', '+02 Africa/Cairo'),
